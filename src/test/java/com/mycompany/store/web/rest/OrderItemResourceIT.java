...
import com.mycompany.store.repository.search.OrderItemSearchRepository;
...
class OrderItemResourceIT {
     ...
     *
     * @see com.mycompany.store.repository.search.OrderItemSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void putNewOrderItem() throws Exception {
        ...
        // Validate the OrderItem in Elasticsearch
        verify(mockOrderItemSearchRepository).save(testOrderItem);
    }
