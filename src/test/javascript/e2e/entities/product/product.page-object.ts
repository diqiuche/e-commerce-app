...
export class ProductUpdatePage {
  ...
  itemSizeSelect = element(by.id('field_itemSize'));
  ...
  async setItemSizeSelect(itemSize: string): Promise<void> {
    await this.itemSizeSelect.sendKeys(itemSize);
  }

  async getItemSizeSelect(): Promise<string> {
    return await this.itemSizeSelect.element(by.css('option:checked')).getText();
  }

  async itemSizeSelectLastOption(): Promise<void> {
    await this.itemSizeSelect.all(by.tagName('option')).last().click();
  }
