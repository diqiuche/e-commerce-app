...
describe('Invoice e2e test', () => {
  ...
  it('should create an instance of Invoice', () => {
    ...
    cy.get(`[data-cy="date"]`).type('2021-06-19T00:36').invoke('val').should('equal', '2021-06-19T00:36');
    ...
    cy.get(`[data-cy="paymentDate"]`).type('2021-06-18T18:17').invoke('val').should('equal', '2021-06-18T18:17');
